...
namespace catchDose
{
    ...
    public class DocSettings_2
    {
        ...
        public static DocSettings_2 ReadSettings()
        {


            DocSettings_2 docSettings = new DocSettings_2();
           ...
           // docSettings.ImportDir = pathMe.DocumentImportDir;//  
